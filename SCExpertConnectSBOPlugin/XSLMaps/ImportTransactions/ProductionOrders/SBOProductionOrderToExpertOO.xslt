			...
			<DATA>
					...
					<xsl:choose>
								 <xsl:when test="BOM/BO/OWOR/row/CardCode != ''">
									 <TARGETCOMPANY><xsl:value-of select="BOM/BO/OWOR/row/CardCode"/></TARGETCOMPANY>
								</xsl:when>
								<xsl:otherwise>
					...
					<REQUESTEDDATE><xsl:value-of select="concat(substring(BOM/BO/OWOR/row/DocDueDate,1,4),'-',substring(BOM/BO/OWOR/row/DocDueDate,5,2),'-',substring(BOM/BO/OWOR/row/DocDueDate,7,2))"/></REQUESTEDDATE>
					<SCHEDULEDDATE><xsl:value-of select="concat(substring(BOM/BO/OWOR/row/DocDueDate,1,4),'-',substring(BOM/BO/OWOR/row/DocDueDate,5,2),'-',substring(BOM/BO/OWOR/row/DocDueDate,7,2))"/></SCHEDULEDDATE>
					...
					<HOSTORDERID><xsl:value-of select="BOM/BO/OWOR/row/Comments"/></HOSTORDERID>
