...
#Region "Ship"
    ...
    'Public Function ShipShipment(ByVal pUser As String)
    ...
    '                    oLoad.Ship(pUser, Convert.ToString(dr("ORDERID")), Convert.ToInt32(dr("ORDERLINE")), Nothing, Nothing, ft.LINES.Line(dr("ORDERLINE")), ft, docType)
    '                Case WMS.Lib.DOCUMENTTYPES.TRANSHIPMENT
    '                    oLoad.Ship(pUser, Convert.ToString(dr("ORDERID")), Convert.ToInt32(dr("ORDERLINE")), Nothing, Nothing, Flowthroughs.getOrder(dr("CONSIGNEE"), dr("ORDERID")).LINES.Line(dr("ORDERLINE")), Flowthroughs.getOrder(dr("CONSIGNEE"), dr("ORDERID")), docType)
    '                Case Else
    ...
    '                    oLoad.Ship(pUser, Convert.ToString(dr("ORDERID")), Convert.ToInt32(dr("ORDERLINE")), Orders.getOrder(dr("CONSIGNEE"), dr("ORDERID")).Lines.GetLine(dr("ORDERLINE")), Orders.getOrder(dr("CONSIGNEE"), dr("ORDERID")), Nothing, Nothing, docType)
    '            End Select
    '        Catch ex As Exception
    '        End Try
    '    Next
...
#Region "RWMS-201 Constructor"

    Public Sub New(ByVal Sender As Object, ByVal CommandName As String, ByVal XMLSchema As String, ByVal XMLData As String, ByRef Message As String)
        Dim ds As New DataSet
        Dim dr As DataRow
        Dim dor As String = String.Empty
        Dim carr As String = String.Empty
        Dim vehicle As String = String.Empty
        Dim trail As String = String.Empty
        Dim drv1 As String = String.Empty
        Dim drv2 As String = String.Empty
        Dim seal1 As String = String.Empty
        Dim seal2 As String = String.Empty
        Dim notes As String = String.Empty
        Dim bol As String = String.Empty
        Dim transporttype As String = String.Empty
        Dim transportreference As String = String.Empty
...
#Region "RWMS-201 Method"

    ' Added for RWMS-201 Start--
    Public Sub PrintLoadingDiagram(ByVal Language As Int32, ByVal pUser As String)
        Dim oQsender As New Made4Net.Shared.QMsgSender
        Dim repType As String
        Dim dt As New DataTable
        repType = "ShipMan"
