...
{
    public partial class RetalixReplTaskManager : ServiceBase
    {
        #region Fields
        ...
        protected bool Connect()
        {
          ...
          //  LicenseUserId = Made4Net.Shared.AppConfig.Get("LicenseUserId", null);
            LicenseUserId = Made4Net.Shared.Util.GetAppConfigNameValue(Made4Net.Shared.ConfigurationSettingsConsts.ExpertReplTaskManagerSection,
                                                     Made4Net.Shared.ConfigurationSettingsConsts.ExpertReplTaskManagerLicenseUserId); // PWMS-817
            try
            {
