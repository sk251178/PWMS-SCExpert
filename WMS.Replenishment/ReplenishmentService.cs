...
{
	public class ReplenishmentService : System.ServiceProcess.ServiceBase
	{
		/// <summary>
		/// Required designer variable.
		/// </summary>
		private System.ComponentModel.Container components = null;
		protected Replenishment rl = null;
		...
		static void Main()
		{
			...
			//
			ServicesToRun = new System.ServiceProcess.ServiceBase[] { new ReplenishmentService() };
		...
		private bool Connect()
		{
            ...
            string licUser = Made4Net.Shared.Util.GetAppConfigNameValue(Made4Net.Shared.ConfigurationSettingsConsts.ReplanishmnetServiceSection,
                    Made4Net.Shared.ConfigurationSettingsConsts.ReplanishmnetServiceLicenseUserId); // PWMS-817
