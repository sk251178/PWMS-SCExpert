...
#Region "Constructors"
    ...
    Public Sub New(ByRef oAgreement As Agreement)
        ...
        For Each dr In dt.Rows
            Dim linenbr As Int32 = CType(dr("line"), Int32)
            Dim trantype As String = CType(dr("trantype"), String)
            Dim agd As AgreementDetail = AgreementDetail.getAgreementLine(_agreement, linenbr, trantype)
...
#Region "Methods"
    ...
    Public Sub SaveLine(ByVal pLine As Int32, ByVal pTrantype As AgreementDetail.TransactionTypes, ByVal pDocumenttype As String _
        ...
        Dim ad As AgreementDetail = Nothing
