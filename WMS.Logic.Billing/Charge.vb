...
#Region "Methods"
    ...
    Protected Sub Load()
        ...
        If Not dr.IsNull("AGREEMENTNAME") Then _agreementname = CType(dr.Item("AGREEMENTNAME"), String)
        If Not dr.IsNull("AGREEMENTLINE") Then _agreementline = CType(dr.Item("AGREEMENTLINE"), Integer)
        If Not dr.IsNull("UNITS") Then _units = CType(dr.Item("UNITS"), Double)
        If Not dr.IsNull("BILLTOTAL") Then _billtotal = CType(dr.Item("BILLTOTAL"), Double)
        If Not dr.IsNull("CURRENCY") Then _currency = CType(dr.Item("CURRENCY"), String)
        If Not dr.IsNull("BILLFROMDATE") Then _billfromdate = CType(dr.Item("BILLFROMDATE"), Date)
        If Not dr.IsNull("BILLTODATE") Then _billtodate = CType(dr.Item("BILLTODATE"), Date)
        If Not dr.IsNull("STATUS") Then _status = CType(dr.Item("STATUS"), String)
        If Not dr.IsNull("CHARGETEXT") Then _chargetext = CType(dr.Item("CHARGETEXT"), String)
        ...
        If Not dr.IsNull("TRANSACTIONID") Then _transactionid = CType(dr.Item("TRANSACTIONID"), String)
...
#Region "Constructors"
    ...
    Public Sub New(ByRef oChargeHeader As ChargeHeader)
        ...
        For Each dr In dt.Rows
            Me.add(New ChargeDetail(_chargeheader, CType(dr.Item("CHARGELINE"), Integer)))
        Next
    End Sub
...
#Region "Methods"
    ...
    Public Shared Function Exist(ByVal chargeid As String) As Boolean
    ...
    Protected Sub Load()
        ...
        If Not dr.IsNull("BILLINGRUNID") Then _billingrunid = CType(dr.Item("BILLINGRUNID"), String)
        ...
        If Not dr.IsNull("BILLFROMDATE") Then _billfromdate = CType(dr.Item("BILLFROMDATE"), Date)
        If Not dr.IsNull("BILLTODATE") Then _billtodate = CType(dr.Item("BILLTODATE"), Date)
        If Not dr.IsNull("BILLTOTAL") Then _billtotal = CType(dr.Item("BILLTOTAL"), Decimal)
        If Not dr.IsNull("STATUS") Then _status = CType(dr.Item("STATUS"), String)
        If Not dr.IsNull("ADDDATE") Then _adddate = CType(dr.Item("ADDDATE"), Date)
        If Not dr.IsNull("ADDUSER") Then _adduser = CType(dr.Item("ADDUSER"), String)
        If Not dr.IsNull("EDITDATE") Then _editdate = CType(dr.Item("EDITDATE"), Date)
