...
#Region "Properties"
    ...
    Public Property StoragePeriodTime() As Int32
        Get
            Return System.Convert.ToInt32(_storageperiodtime)
        End Get
        Set(ByVal Value As Int32)
            _storageperiodtime = Value.ToString()
        End Set
    End Property
...
#Region "Data Methods"
    ...
    Protected Function getNextLine() As Int32
        Return System.Convert.ToInt32(DataInterface.ExecuteScalar("SELECT ISNULL(MAX(LINE),0) + 1 FROM BILLINGAGREEMENTDETAIL WHERE AGREEMENTNAME = '" & _agreement.Name & "' AND CONSIGNEE='" & _agreement.Consignee & "'"))
    End Function
    ...
    Public Shared Function getAgreementLine(ByRef oAgreement As Agreement, ByVal iLineNumber As Int32) As AgreementDetail
        ...
        Try
            Dim sTranType As String = DataInterface.ExecuteScalar(sql).ToString()
    ...
    Protected Overridable Sub Load()
        ...
        If dt.Rows.Count = 0 Then
            ...
            m4nEx.Params.Add("line", CType(_line, String))
            Throw m4nEx
        End If
        ...
        If Not dr.IsNull("DOCUMENTTYPE") Then _documenttype = CType(dr.Item("DOCUMENTTYPE"), String)
        ...
        If Not dr.IsNull("PRICEPERUNIT") Then _priceperunit = CType(dr.Item("PRICEPERUNIT"), Double)
        If Not dr.IsNull("ISPERCENTAGE") Then _ispercentage = CType(dr.Item("ISPERCENTAGE"), Boolean)
        If Not dr.IsNull("PERCENTAGE") Then _percentage = CType(dr.Item("PERCENTAGE"), Double)
        If Not dr.IsNull("USEPRICELIST") Then _usepricelist = CType(dr.Item("USEPRICELIST"), Boolean)
        If _usepricelist And Not dr.IsNull("PRICELIST") Then _pricelist = New PriceList(CType(dr("PRICELIST"), String))
        If Not dr.IsNull("CURRENCY") Then _currency = CType(dr.Item("CURRENCY"), String)
        If Not dr.IsNull("MINPERTRAN") Then _minpertran = CType(dr.Item("MINPERTRAN"), Double)
        If Not dr.IsNull("MAXPERTRAN") Then _maxpertran = CType(dr.Item("MAXPERTRAN"), Double)
        If Not dr.IsNull("MINPERRUN") Then _minperrun = CType(dr.Item("MINPERRUN"), Double)
        If Not dr.IsNull("MAXPERRUN") Then _maxperrun = CType(dr.Item("MAXPERRUN"), Double)
        ...
        If Not dr.IsNull("SKUGROUP") Then _skugroup = CType(dr.Item("SKUGROUP"), String)
        If Not dr.IsNull("ENDDATE") Then _enddate = CType(dr.Item("ENDDATE"), Date)
        If Not dr.IsNull("RUNCONDITION") Then _runcondition = CType(dr.Item("RUNCONDITION"), String)
        If Not dr.IsNull("STORAGEPERIODTIME") Then _storageperiodtime = CType(dr.Item("STORAGEPERIODTIME"), String)
        If Not dr.IsNull("STORAGEPERIODTYPE") Then _storageperiodtype = BillingUtils.PeriodTypesFromString(CType(dr.Item("STORAGEPERIODTYPE"), String))
        ...
        If Not dr.IsNull("INITIALSTORAGELINE") Then _initialstorageline = CType(dr.Item("INITIALSTORAGELINE"), Integer)

        If Not dr.IsNull("CHARGEDESCRIPTION") Then _chargedescription = CType(dr.Item("CHARGEDESCRIPTION"), String)
        If Not dr.IsNull("HANDLINGUNITTYPE") Then _hutype = CType(dr.Item("HANDLINGUNITTYPE"), String)
        Try
            If Not dr.IsNull("TRANSPORTREFERENCE") Then _transportreference = CType(dr.Item("TRANSPORTREFERENCE"), String)
            If Not dr.IsNull("TRANSPORTTYPE") Then _transporttype = CType(dr.Item("TRANSPORTTYPE"), String)
        Catch ex As Exception
        End Try
        If Not dr.IsNull("STORAGEPARTIALPERIOD") Then _storagepartialperiod = CType(dr.Item("STORAGEPARTIALPERIOD"), Boolean)

        If Not dr.IsNull("PickType") Then _picktype = CType(dr.Item("PickType"), String)
        If Not dr.IsNull("CLASSNAME") Then _classname = CType(dr.Item("CLASSNAME"), String)
        If Not dr.IsNull("STORAGECLASS") Then _storageclass = CType(dr.Item("STORAGECLASS"), String)
        If Not dr.IsNull("ISSTORAGERANGE") Then _isstoragerange = CType(dr.Item("ISSTORAGERANGE"), Boolean)
...
#Region "Accessors"
    ...
    Public Shared Function TransactionTypeFromString(ByVal t As Object) As TransactionTypes
        If t.GetType() Is GetType(String) Then
            Dim ts As String = TryCast(t, String)

            Select Case ts.ToUpper
                Case "CONSTANT"
    ...
    Public Shared Function BillingBasisFromString(ByVal bu As Object) As BillingBasis
        If bu.GetType() Is GetType(String) Then
            Dim bus As String = TryCast(bu, String)
            Select Case bus.ToUpper
                Case "NUMLINES"
...
#End Region
    ...
    Private Function getChargeValue(ByVal DaysInPeriod As Int32, ByVal dStartBillingPeriod As Date, ByVal dEndBillingPeriod As Date, ByVal sbic As StorageBillingCollection, ByVal IsDateRange As Boolean, Optional ByVal PriceConvertion As Decimal = 1, Optional ByVal logger As WMS.Logic.LogHandler = Nothing) As Decimal
        ...
        For Each sbi As StorageBillingInventory In sbic.Values
            ...
            _pricefactor = CType(oPriceFactorCalc.CalculatePriceFactor(_pricefactorindex, _
                dStartDate.ToString("dd/MM/yyyy"), Nothing).ToString(), Double)
            If Not logger Is Nothing Then
            ...
            If _storagepartialperiod Then
                StoragePartialPeriodCoop = CType(iNumOfDays / DaysInPeriod, Decimal)
            End If
    ...
    Protected Function getChargeValue(ByVal chargeUnits As Decimal, Optional ByVal DocType As String = "", Optional ByVal DocID As String = "", Optional ByVal PriceConvertion As Decimal = 1, Optional ByVal logger As WMS.Logic.LogHandler = Nothing) As Decimal ', Optional ByVal PriceListChargeUnits As Decimal = -1, Optional ByVal pUsePriceListChargeUnits As Boolean = True) As Decimal
        ...
        Return CType(calcValue, Decimal)
    End Function
    '#End Region
