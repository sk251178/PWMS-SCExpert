	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" MS_POSITIONING="FlowLayout">
		<FORM id="Form1" method="post" runat="server">
			<cc3:screen id="Screen1" runat="server" ScreenID="sfti"></cc3:screen>
					<TABLE id="Table1" cellSpacing="0" cellPadding="0" border="0" runat="server" style="width: 201px">
						<TR align="left">
						    <TD style="width: 201px; height: 93px">
						        <table id="tblClockIn" border="2" bordercolor="#9999ff">
						            <tr>
						...
						<tr align="left">
						    <td>
						        <h1><span>Task Assignment</span></h1>
						    </td>
						</tr>
						<TR align="left">
						    <TD style="width: 201px; height: 97px" align="left">
						        <table id="tblTask" border="2" bordercolor="#9999ff" title="Task Assignment">
						            <tr>
						                <td style="width: 201px; height: 66px">
