...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="DriversPoint.aspx.vb" Inherits="WMS.WebApp.DriversPoint" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Driver Point</title>
...
//-->
		...
		<form id="Form1" method="post" runat="server">
			...
			<cc3:screen id="Screen1" runat="server" ScreenID="dp" NoLoginRequired="True"></cc3:screen>
			<table style="BORDER-RIGHT: black 1px solid; BORDER-TOP: black 1px solid; BORDER-LEFT: black 1px solid; BORDER-BOTTOM: black 1px solid"
				...
				<TBODY>
					...
					<tr>
						<td height="270px" style="BORDER-TOP: black 1px solid"><iframe src="Driver.aspx" width="100%" height="100%" frameborder="no" id="frmDrivers" name="frmDrivers"></iframe>
						</td>
					</tr>
				</TBODY>
			</table>
