...
<%@ Page Language="vb" AutoEventWireup="false"%><!-- Codebehind="HUTOutbound.aspx.vb" Inherits="WMS.WebApp.HUTOutbound" %>-->
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" >
<html>
  <head>
    <title>HUTOutbound</title>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" MS_POSITIONING="FlowLayout">
		...
		<form id="Form1" method="post" runat="server">
			...
			<cc3:screen id="Screen1" runat="server" ScreenID="huto"></cc3:screen>
			<P><cc2:tableeditor id="TEHUTInbound" runat="server" DisableSwitches="nime" ForbidRequiredFieldsInSearchMode="True"
					...
					AutoSelectGridItem="Never" AutoSelectMode="View" FilterExpression="TRANSACTIONTYPE IN ('OUTBOUND','SHIPMENT')"></cc2:tableeditor></P>
			<P>&nbsp;</P>
		</form>
	</body>
</html>
