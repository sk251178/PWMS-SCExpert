<%@ Page Language="vb" AutoEventWireup="false" Codebehind="VehiclePositionMap.aspx.vb" Inherits="WMS.WebApp.VehiclePositionMap" %>
<%@ Register TagPrefix="cc3" Namespace="WMS.WebCtrls.WebCtrls" Assembly="WMS.WebCtrls" %>
<%@ Register TagPrefix="cc2" Namespace="Made4Net.WebControls" Assembly="Made4Net.WebControls" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>VehiclePositionMap</title>
...
//-->
		...
		<form id="Form1" method="post" runat="server">
			...
			<table cellpadding="0" cellspacing="0">
				<TBODY>
					<tr>
						<td width="70%" height="100%" style="BORDER-RIGHT: black 1px solid; BORDER-TOP: black 1px solid; BORDER-LEFT: black 1px solid; BORDER-BOTTOM: black 1px solid"><iframe src="VehiclePosition.aspx" width="100%" height="100%" frameborder="no" id="frmPinGrid"
								name="frmPinGrid" DESIGNTIMEDRAGDROP="14"></iframe>
						</td>
						<td width="30%">
