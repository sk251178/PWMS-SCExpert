...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="DepotsPoint.aspx.vb" Inherits="WMS.WebApp.DepotsPoint" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Depots Point</title>
		...
		<form id="Form1" method="post" runat="server">
			...
			<table style="BORDER-RIGHT: black 1px solid; BORDER-TOP: black 1px solid; BORDER-LEFT: black 1px solid; BORDER-BOTTOM: black 1px solid"
				...
				<TBODY>
					...
					<tr>
						<td height="270" style="BORDER-TOP: black 1px solid"><iframe src="Depots.aspx" width="100%" height="100%" frameborder="no" id="frmDepots" name="frmDepots"></iframe>
						</td>
					</tr>
				</TBODY>
			</table>
