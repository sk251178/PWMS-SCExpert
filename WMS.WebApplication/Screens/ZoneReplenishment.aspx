...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ZoneReplenishment.aspx.vb" Inherits="WMS.WebApp.ZoneReplenishment"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>ZoneReplenishment</title>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" MS_POSITIONING="FlowLayout">
		...
		<form id="Form1" method="post" runat="server">
			...
			<P><cc2:tableeditor id="TEReplenish" runat="server" DESIGNTIMEDRAGDROP="14" DefaultMode="Grid" DefaultDT="DTZoneRepl"
					SearchDT="DTZoneReplSearch" DisableSwitches="nvriedvt" AutoSelectGridItem="Never" AutoSelectMode="View"
