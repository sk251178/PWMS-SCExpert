<%@ Page Language="vb" AutoEventWireup="false" Codebehind="WHActivityViewer.aspx.vb" Inherits="WMS.WebApp.WHActivityViewer"%>
...
<HTML>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" MS_POSITIONING="FlowLayout">
		...
		<form id="Form1" method="post" runat="server">
			...
			<cc3:screen id="Screen1" runat="server" ScreenID="wv"></cc3:screen>
			<YARDDIAGRAM:DIAGRAMVIEWER id="DV" runat="server" GridWidth="0" GridHeight="0" GridLayoutStyle="Dot" Width="815px"
				...
				GridXRatio="20" GridYRatio="30" ShowLegend="True"></YARDDIAGRAM:DIAGRAMVIEWER>
			<P></P>
		</form>
