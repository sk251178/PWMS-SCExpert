	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" MS_POSITIONING="FlowLayout">
		...
		<FORM id="Form1" method="post" runat="server">
			...
			<P ><cc2:tableeditor id="TEShiftMaster" runat="server" GridDT="DTShiftMaster" DefaultDT="DTShiftMaster" SearchDT="DTShiftMaster"
					...
					InsertDT="DTShiftMaster" EditDT="DTShiftMaster" SortExperssion="SHIFTCODE">
						...
						<TR>
							<TD>
								...
								<cc2:tabstrip id="TBC" runat="server" TargetTableID="Tbl" SepDefaultStyle="border-bottom:solid 1px gray;"
									...
									<iewc:Tab Text="Breaks"></iewc:Tab>
									<iewc:TabSeparator></iewc:TabSeparator>
									<iewc:Tab Text="Users"></iewc:Tab>
									<iewc:TabSeparator></iewc:TabSeparator>
									<iewc:Tab Text="Users Not In Shift"></iewc:Tab>
								...
								<TABLE id="Tbl" cellSpacing="0" cellPadding="5" border="0" runat="server">
                                    ...
                                    <td>
											...
											<cc2:TableEditor id="TEUserDefShift" runat="server" EditDT="DTUserDefShift" 
											   SQL="SELECT USERID,FULLNAME,DEFAULTSHIFT,WAREHOUSE FROM VUSERWAREHOUSEFORSHIFT"  ConnectionName = "Made4NetSchema"    
                                                SortExpression="userid"   
											  ForbidRequiredFieldsInSearchMode="True" DefaultMode="Grid"  DisableSwitches="mniev"
											...
											<cc2:DataConnector id="DCUserDefShift" runat="server" DESIGNTIMEDRAGDROP="38" TargetID="TEUserDefShift" MasterFields="SHIFTCODE"
												ChildFields="DEFAULTSHIFT" MasterObjID="TEShiftMaster"></cc2:DataConnector>
										    </TD> 
                                            <td>
                                        	<cc2:TableEditor id="TEUserDefNotInShift" runat="server" 
											   SQL="SELECT USERID,FULLNAME,DEFAULTSHIFT,WAREHOUSE FROM VUSERWAREHOUSEFORSHIFT"  ConnectionName = "Made4NetSchema"    
                                                SortExpression="userid"  DisableSwitches="mniev" 
