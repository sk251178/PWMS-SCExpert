...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Network.aspx.vb" Inherits="WMS.WebApp.NetWork" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Routing Sample Nir</title>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" MS_POSITIONING="FlowLayout">
		<FORM id="Form1" method="post" runat="server">
			<cc3:Screen id="Screen1" runat="server" HideBanner="False" HideMenu="False" NoLoginRequired="True"></cc3:Screen>
			<br>
