...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents TESKUClass As Made4Net.WebControls.TableEditor
    <CLSCompliant(False)> Protected WithEvents TS As Made4Net.WebControls.TabStrip
    Protected WithEvents TESkuClassAttributes As Made4Net.WebControls.TableEditor
    Protected WithEvents DC1 As Made4Net.WebControls.DataConnector
    Protected WithEvents TESkuClassLoadAttributes As Made4Net.WebControls.TableEditor
    Protected WithEvents TESkuClassLoadDetAttributes As Made4Net.WebControls.TableEditor
