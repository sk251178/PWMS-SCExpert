...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents TEPWDETAIL As Made4Net.WebControls.TableEditor
...
#Region "Ctor"
    ...
    Public Sub New(ByVal pSender As Object, ByVal pCommandName As String, ByVal pXMLSchema As String, ByVal pXMLData As String, ByRef pMessage As String)
        ...
        Select Case pCommandName.ToLower
            Case "deleteheader"
                Dim ppObj As New WMS.Logic.PutawayPolicy(ds.Tables(0).Rows(0)("PutawayPolicy"))
                ppObj.Delete()
        End Select
    End Sub
...
#End Region
    ...
    Protected Sub TEPW_CreatedChildControls(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TEPW.CreatedChildControls
        If TEPW.CurrentMode = Made4Net.WebControls.TableEditorMode.Edit Then
            With TEPW.ActionBar.Button("Delete")
                .ObjectDLL = "WMS.WebAPP.dll"
                .ObjectName = "WMS.WebApp.PutawayPolicies"
