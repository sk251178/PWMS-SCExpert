...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RealTableMaintenance.aspx.vb" Inherits="WMS.WebApp.RealTableMaintenance" ValidateRequest="false" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<P>&nbsp;
				<TABLE id="Table1" cellSpacing="0" cellPadding="3" width="350" border="0">
					...
					<TR>
						<TD>
							<cc2:DropDownListValidated id="ddSysTable" runat="server" AutoPostBack="True" DESIGNTIMEDRAGDROP="93" AllOption="True"></cc2:DropDownListValidated></TD>
						<TD>
							<cc2:DropDownListValidated id="ddAppTable" runat="server" AutoPostBack="True" AllOption="True"></cc2:DropDownListValidated></TD>
					</TR>
				</TABLE>
			</P>
			<HR width="100%" SIZE="1">
