...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        DV.DataLoader = New WMS.Logic.WHMapViewerDataLoader
    End Sub

    Private Sub LoadTemplates(ByRef TemplatesArray As ArrayList)
        LoadNodesTemplates(TemplatesArray)
    End Sub

    Private Sub LoadNodesTemplates(ByRef TemplatesArray As ArrayList)
        Dim SQL As String = String.Format("select distinct TemplateName,TemplateWidth,TemplateHeight from vWHMapNodes")
        ...
        'TemplatesArray.Add(New ObjectTemplateParams(ObjectType.StaticObject, "DefaultStatic", 0.0F, 0.0F, HttpContext.Current.Request.MapPath(Made4Net.WebControls.SkinManager.GetImageURL("WHMapNodes_Default"))))
    End Sub
