...
#Region " Web Form Designer Generated Code "
    ...
    Protected TEInvConsSkuLoad As Made4Net.WebControls.TableEditor
    ...
    Protected TEInvByConsignee As Made4Net.WebControls.TableEditor
    Protected DC1 As Made4Net.WebControls.DataConnector
    Protected WithEvents TEInvConsSku As Made4Net.WebControls.TableEditor
    Protected WithEvents DC2 As Made4Net.WebControls.DataConnector
    Protected WithEvents TEInvConsSkuByLocation As Made4Net.WebControls.TableEditor
    Protected WithEvents TEInvConsSkuByLoadAtt As Made4Net.WebControls.TableEditor
