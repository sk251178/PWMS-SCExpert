	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" MS_POSITIONING="FlowLayout">
		...
		<form id="Form1" method="post" runat="server">
			...
			<P><cc2:tableeditor id="TESHIFTPERF" runat="server" GridDT="DTShiftPerformanceSummary" AfterUpdateMode="Grid"
					...
					DefaultMode="Grid" ManualMode="False" DefaultDT="DTShiftPerformanceSummary" EditDT="DTShiftPerformanceSummary"
					ViewDT="DTShiftPerformanceSummary" SortExperssion="STARTDATE, SHIFTCODE DESC" ObjectID="TESHIFTPERF" AutoSelectGridItem="Never" AutoSelectMode="View"></cc2:tableeditor></P>
			<P>&nbsp;</P>
								...
								<TABLE id="Tbl" cellSpacing="0" cellPadding="5" border="0" runat="server">
									<TR>
										<TD>
											...
											<cc2:DataConnector id="DC1" runat="server" DESIGNTIMEDRAGDROP="43" TargetID="TEUSERPERF" MasterFields="SHIFTCODE"
										...
										<TD>
											...
											<cc2:DataConnector id="DC2" runat="server" DESIGNTIMEDRAGDROP="43" TargetID="TEPERFBYTASK" MasterFields="SHIFTCODE"
												ChildFields="SHIFTCODE" MasterObjID="TESHIFTPERF"></cc2:DataConnector></TD>
										<TD>
