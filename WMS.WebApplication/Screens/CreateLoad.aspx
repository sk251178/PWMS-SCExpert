...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CreateLoad.aspx.vb" Inherits="WMS.WebApp.CreateLoad"%>
...
<HTML>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" MS_POSITIONING="FlowLayout">
		...
		<form id="Form1" method="post" runat="server">
			...
			<cc3:screen id="Screen1" runat="server" ScreenID="cl"></cc3:screen>
			<P><cc2:tableeditor id="TECL" runat="server" DESIGNTIMEDRAGDROP="14" GridPageSize="5" TableName="RECEIPTDETAIL"
					DefaultMode="Search" ManualMode="False" DefaultDT="DTCL" DisableSwitches="eidmn" GridDT="DTCLRDETAIL"
					ViewDT="DTCLRDETAIL" ForbidRequiredFieldsInSearchMode="True" AutoSelectGridItem="Never"
