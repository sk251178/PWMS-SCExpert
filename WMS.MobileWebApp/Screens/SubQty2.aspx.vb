...
Partial Public Class SubQty2
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            If (Session("LoadStatusUpdateLoadId") Is Nothing) Then
    ...
    Private Sub doBack()
        Session.Remove("LoadStatusUpdateLoadId")
        Response.Redirect(MapVirtualPath("Screens/SubQty.aspx"))
    End Sub
    ...
    Private Sub doNext()
        ...
        Try
            ...
            If Not ManageMutliUOMUnits.AddUOMUnits(DO1.Value("UOM"), DO1.Value("ADJUSTQTY"), errMessage) Then
            ...
            units = ManageMutliUOMUnits.GetTotalEachUnits() 'GetTotal() 'oSku.ConvertToUnits(DO1.Value("UOM")) * Convert.ToDecimal(DO1.Value("ADJUSTQTY"))

            If units > ld.UNITS Then
                HandheldPopupNAlertMessageHandler.DisplayMessage(Me,  "Adjusted Qty cannot be greater than the payload quantity")
                Return
            End If

            ld.Adjust(WMS.Lib.Actions.Audit.SUBQTY, units, DO1.Value("ReasonCode"), WMS.Logic.GetCurrentUser)
    ...
    Private Sub DO1_CreatedChildControls(ByVal sender As Object, ByVal e As System.EventArgs) Handles DO1.CreatedChildControls
        ...
        DO1.AddTextboxLine("ADJUSTQTY", False, "sub qty")
