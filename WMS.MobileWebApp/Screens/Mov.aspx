...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Mov.aspx.vb" Inherits="WMS.MobileWebApp.Mov" %>
...
<HTML>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			...
			<div align="center"><cc1:screen id="Screen1" runat="server" title="Move RDT" ScreenID="rdtmov"></cc1:screen></div>
