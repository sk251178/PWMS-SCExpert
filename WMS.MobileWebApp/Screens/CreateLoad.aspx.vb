...
<CLSCompliant(False)> Public Class CreateLoad
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        If Not IsPostBack Then
            If Session("CreateLoadCRN") Is Nothing Then
                Response.Redirect(MapVirtualPath("Screens/CreateLoadSelectCRN.aspx"))
            End If
        End If
    End Sub
...
#End Region
    ...
    Dim WithEvents btnCRN As Button
    ...
    Private Sub DOCreateLoad_CreatedChildControls(ByVal sender As Object, ByVal e As System.EventArgs) Handles DOCreateLoad.CreatedChildControls
        btnCRN = New Made4Net.WebControls.Button
        btnCRN.Text = "Select Receipt..."
        DOCreateLoad.Content.Controls.AddAt(0, btnCRN)
    ...
    Private Sub btnCRN_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCRN.Click
        Response.Redirect(MapVirtualPath("Screens/CreateLoadSelectCRN.aspx"))
    End Sub
End Class
