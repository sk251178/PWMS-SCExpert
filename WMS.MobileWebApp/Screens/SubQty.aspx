<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SubQty.aspx.vb" Inherits="WMS.MobileWebApp.SubQty" %>
...
<body  bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			...
			<div align="center"><cc1:screen id="Screen1" runat="server" title="Inventory Adjustment – Sub Quantity" ScreenID="rdtSubQty"></cc1:screen></div>
