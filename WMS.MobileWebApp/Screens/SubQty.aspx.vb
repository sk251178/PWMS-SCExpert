...
Partial Public Class SubQty
    Inherits PWMSRDTBase
    Dim consignee As String = String.Empty ''RWMS-1371
    ...
    Private Sub DO1_CreatedChildControls(ByVal sender As Object, ByVal e As System.EventArgs) Handles DO1.CreatedChildControls
        ...
        'DO1.AddDropDown("CONSIGNEE", Session("3PL"))'RWMS-1371
    ...
    Private Sub doNext()
        ...
        Try
            ...
            If DO1.Value("LOADID").Trim = "" Then
                ...
                If DO1.Value("SKU").Trim <> "" Then
                    ...
                    ElseIf Not WMS.Logic.SKU.Exists(consignee, DO1.Value("SKU")) Then ''RWMS-1371
            ...
            If DO1.Value("SKU") <> "" And consignee <> "" Then ''RWMS-1371
                If Not WMS.Logic.SKU.Exists(consignee, DO1.Value("SKU")) Then 'RWMS-1371
                    HandheldPopupNAlertMessageHandler.DisplayMessage(Me,  trans.Translate("SKU does not exist"))
                    CLEAR()
                    Exit Sub
                End If
                oSku = New WMS.Logic.SKU(consignee, DO1.Value("SKU")) 'RWMS-1371
            Else
        ...
        Catch ex As Exception
            ...
            Return
        End Try
        Response.Redirect(MapVirtualPath("Screens/SubQty2.aspx"))
