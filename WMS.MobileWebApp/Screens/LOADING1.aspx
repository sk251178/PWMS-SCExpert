...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="LOADING1.aspx.vb" Inherits="WMS.MobileWebApp.LOADING1"%>
...
<HTML>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			...
			<DIV align="center"><cc1:screen id="Screen1" runat="server" ScreenID="LOAD1"></cc1:screen></DIV>
