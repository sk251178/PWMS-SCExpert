...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CLD4.aspx.vb" Inherits="WMS.MobileWebApp.CLD4" %>
...
<HTML>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			...
			<DIV align="center"><cc2:dataobject id="DO1" runat="server" LeftButtonText="Create" RightButtonText="changeline" title="Create Load"></cc2:dataobject></DIV>
		</form>
	</body>
</HTML>
