<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CLDBLD1.aspx.vb" Inherits="WMS.MobileWebApp.CLDBLD1"%>
  ...
  <head>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			...
			<div align="center"><cc1:screen id="Screen1" runat="server" title="CREATE LOAD" ScreenID="CLDBLD1"></cc1:screen></div>
