<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="vrfi.aspx.vb" Inherits="WMS.MobileWebApp.vrfi" %>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
            <telerik:RadScriptManager ID="RadScriptManager2" runat="server">     </telerik:RadScriptManager> 
    			<div align="center"><cc1:screen id="Screen1" runat="server" title="Verify LOAD" ScreenID="RDTVRF">
			</cc1:screen></div>
