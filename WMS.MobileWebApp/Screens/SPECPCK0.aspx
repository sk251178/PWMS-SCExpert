...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SPECPCK0.aspx.vb" Inherits="WMS.MobileWebApp.SPECPCK0" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>SPECPCK0</title>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" name="Form1" method="post" runat="server">
			...
			<div align="center"><cc1:screen id="Screen1" title="Picking" runat="server" ScreenID="RDTPCKSPEC0"></cc1:screen></div>
			<DIV align="center"><cc2:dataobject id="DO1" runat="server" LeftButtonText="next" RightButtonText="Menu" title="Picking"
					CenterButtonText="NextSku"></cc2:dataobject></DIV>
		</form>
	</body>
</HTML>