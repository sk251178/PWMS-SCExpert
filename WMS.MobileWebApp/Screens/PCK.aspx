<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PCK.aspx.vb" Inherits="WMS.MobileWebApp.PCK" %>
...
<HTML>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		...
		<form id="Form1" name="Form1" method="post" runat="server">
			...
			<div align="center"><cc1:screen id="Screen1" title="Picking" runat="server" ScreenID="RDTPCK"></cc1:screen></div>
