<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="VERIFYCANCELALL.aspx.vb" Inherits="WMS.MobileWebApp.VERIFYCANCELALL" %>
...
<HTML>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			...
			<DIV align="center"><cc1:screen id="Screen1" runat="server" title="Verify LOAD" ScreenID="RDTVRFCANCELALL"></cc1:screen></DIV>
