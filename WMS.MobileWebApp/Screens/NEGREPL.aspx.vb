...
<CLSCompliant(False)> Public Class NEGREPL
...
#End Region
    ...
    Private Function CheckAssigned() As Boolean
        ...
        ReplTask = tm.RequestTask(WMS.Logic.Common.GetCurrentUser, WMS.Lib.TASKTYPE.NEGTREPL)
    ...
    Private Sub doNext()
        If Session("REPLTSKTaskId") Is Nothing Then
            ...
            Try
                ...
                ts.RequestTask(WMS.Logic.GetCurrentUser, WMS.Lib.TASKTYPE.NEGTREPL)
                CheckAssigned()
