<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PCKPART.aspx.vb" Inherits="WMS.MobileWebApp.PCKPART" %>
...
<HTML>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			...
			<DIV align="center"><cc1:screen id="Screen1" runat="server" title="Picking" ScreenID="RDTPCKPART"></cc1:screen></DIV>
			<DIV align="center" width="100%"><cc2:dataobject id="DO1" runat="server" LeftButtonText="Next" CenterButtonText="close container" RightButtonText="Back" 
