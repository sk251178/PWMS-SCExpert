...
<CLSCompliant(False)> Public Class PARTREPL
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            Else
                Session("REPLSRCSCREEN") = "PARTREPL"
            End If
    ...
    Private Function CheckAssigned() As Boolean
        ...
        ReplTask = tm.RequestTask(WMS.Logic.Common.GetCurrentUser, WMS.Lib.TASKTYPE.PARTREPL)
    ...
    Private Sub doMenu()
        If Not Session("REPLTSKTaskId") Is Nothing Then
            Dim tm As WLTaskManager = WLTaskManager.NewTaskManagerForTask(CType(Session("REPLTSKTaskId"), WMS.Logic.ReplenishmentTask).TASK)
            Try
                tm.ExitTask()
    ...
    Private Sub doNext()
        If Session("REPLTSKTaskId") Is Nothing Then
            ...
            Try
                ...
                ts.RequestTask(WMS.Logic.GetCurrentUser, WMS.Lib.TASKTYPE.PARTREPL)
                CheckAssigned()
