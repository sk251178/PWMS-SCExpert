Imports WMS.Logic
<CLSCompliant(False)> Public Class BLKRCV
...
#End Region
    ...
    Private Sub DO1_CreatedChildControls(ByVal sender As Object, ByVal e As System.EventArgs) Handles DO1.CreatedChildControls
        ...
        DO1.AddTextboxLine("RECEIPTID", True, "create")
    ...
    Private Sub doCreateContainer()
        ...
        Response.Redirect(Made4Net.Shared.Web.MapVirtualPath("Screens/BLKRCV1.aspx"))
    End Sub
