...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SkuInq2.aspx.vb" Inherits="WMS.MobileWebApp.SkuInq2" %>
...
<HTML>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			...
			<DIV align="center"><cc1:screen id="Screen1" runat="server" ScreenID="rdtskuinq2"></cc1:screen></DIV>
			<DIV align="center" width="100%"><cc2:dataobject id="DO1" runat="server"  LeftButtonText="Next" RightButtonText="Menu"
					title="Picking"></cc2:dataobject></DIV>
		</form>
	</body>
</HTML>
