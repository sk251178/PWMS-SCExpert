<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PCKP.aspx.vb" Inherits="WMS.MobileWebApp.PCKP"%>
...
<HTML>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" name="Form1" method="post" runat="server">
			...
			<div align="center"><cc1:screen id="Screen1" title="Picking" runat="server" ScreenID="PCKP"></cc1:screen></div>
