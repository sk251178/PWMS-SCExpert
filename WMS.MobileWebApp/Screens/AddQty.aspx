<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AddQty.aspx.vb" Inherits="WMS.MobileWebApp.AddQty" %>
...
<body  bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			...
			<div align="center"><cc1:screen id="Screen1" runat="server" title="Inventory Adjustment – Add Quantity" ScreenID="rdtAddQty"></cc1:screen></div>
