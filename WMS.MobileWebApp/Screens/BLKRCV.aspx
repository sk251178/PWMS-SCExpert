<%@ Page Language="vb" AutoEventWireup="false" Codebehind="BLKRCV.aspx.vb" Inherits="WMS.MobileWebApp.BLKRCV" %>
  ...
  <head>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			...
			<div align="center"><cc1:screen id="Screen1" runat="server" title="Create Bulk Receiving" ScreenID="blkrcv"></cc1:screen></div>
