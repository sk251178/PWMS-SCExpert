<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="NewQty2.aspx.vb" Inherits="WMS.MobileWebApp.NewQty2" %>
...
<body  bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			...
			<div align="center"><cc1:screen id="Screen1" runat="server" title="Inventory Adjustment – New Quantity" ScreenID="rdtNewQty2"></cc1:screen></div>
