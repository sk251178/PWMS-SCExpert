<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="VRFICONFITEM.aspx.vb" Inherits="WMS.MobileWebApp.VRFICONFITEM" %>
...
<HTML>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			...
			<DIV align="center"><cc1:screen id="Screen1" runat="server" title="Verify LOAD" ScreenID="RDTVRF5"></cc1:screen></DIV>
