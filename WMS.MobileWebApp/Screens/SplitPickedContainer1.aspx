<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SplitPickedContainer1.aspx.vb" Inherits="WMS.MobileWebApp.SplitPickedContainer2" %>
...
<head runat="server">
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			...
			<div align="center"><cc1:screen id="Screen1" runat="server" ScreenID="spcont1"></cc1:screen></div>
