...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CMX1.aspx.vb" Inherits="WMS.MobileWebApp.CMX1"%>
  ...
  <head>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			...
			<div align="center"><cc1:screen id="Screen1" runat="server" title="Create Mix Container" ScreenID="cmx1"></cc1:screen></div>
			<DIV align="center" width="100%"><cc2:dataobject id="DO1" runat="server" LeftButtonText="NextLoad" RightButtonText="CloseContainer"
					title="Create Mix Container" CenterButtonText="PickUpContainer"></cc2:dataobject></DIV>
		</form>
	</body>
</html>
