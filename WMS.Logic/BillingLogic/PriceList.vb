...
#Region "Constructors"
    ...
    Public Sub New(ByVal Sender As Object, ByVal CommandName As String, ByVal XMLSchema As String, ByVal XMLData As String, ByRef Message As String)
        ...
        If CommandName.ToLower = "createnew" Then
            ...
            Create(dr("name"), Convert.ReplaceDBNull(dr("DESCRIPTION")), Convert.ReplaceDBNull(dr("PRICELISTTYPE")), dr("ACTIVE"), dr("ISDATERANGE"), Common.GetCurrentUser)
        ElseIf CommandName.ToLower = "update" Then
            dr = ds.Tables(0).Rows(0)
            _name = dr("name")
            update(Convert.ReplaceDBNull(dr("DESCRIPTION")), Convert.ReplaceDBNull(dr("PRICELISTTYPE")), dr("ACTIVE"), dr("ISDATERANGE"), Common.GetCurrentUser)
        End If
    End Sub
...
#Region "Create / Update"
    ...
    Public Sub Create(ByVal pName As String, ByVal pDescription As String, ByVal pType As String, ByVal pActive As Boolean, ByVal pIsDateRange As Boolean, ByVal pUser As String)
        ...
        If WMS.Logic.PriceList.Exists(pName) Then
