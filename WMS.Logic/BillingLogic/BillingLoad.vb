...
#Region "Private Methods"
    ...
    Private Sub Load(Optional ByVal bFullLoad As Boolean = True)
        ...
        If Not dr.IsNull("BILLINGLOADID") Then _billingloadid = dr.Item("BILLINGLOADID")
        ...
        If Not dr.IsNull("LASTDATE") Then _lastdate = dr.Item("LASTDATE")
...
#Region "Transaction writing methods"
    ...
    Public Function WriteAddLoadQty(ByVal sLoadId As String, ByVal sConsignee As String, ByVal sSku As String, ByVal sUOM As String, ByVal mQty As Decimal, ByVal dtTransactionDate As DateTime, ByVal pStartDate As DateTime)
    ...
    Public Function WriteSubLoadQty(ByVal sLoadId As String, ByVal sConsignee As String, ByVal sSku As String, ByVal sUOM As String, ByVal mQty As Decimal, ByVal dtTransactionDate As DateTime, ByVal SetEndDate As Boolean)
    ...
    Private Function IsWritingFinished(ByVal pLoadID As String) As Boolean
        ...
        Dim countEnded As Integer = Integer.Parse(Made4Net.DataAccess.DataInterface.ExecuteScalar(sql))
