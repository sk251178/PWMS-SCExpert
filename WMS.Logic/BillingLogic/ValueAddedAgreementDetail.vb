...
Public Class ValueAddedAgreementDetail
    ...
    Public Overrides Function Process(ByVal runToDate As Date, ByVal logger As LogHandler, ByVal pUser As String, ByVal SaveStorageTransactions As String, Optional ByVal ch As ChargeHeader = Nothing) As ChargeDetailCollection
        ...
        While _nextrundate.Date <= runToDate
            ...
            sql = String.Format("SELECT ORDERID, " & _
                                ...
                                "WHERE WORKORDERHEADER.STATUS='COMPLETE' AND WORKORDERHEADER.DOCUMENTTYPE='VALUEADDED' AND " & _
                                " CLOSEDATE >= {0} AND CLOSEDATE <= {1} " & _
                                " AND WORKORDERHEADER.CONSIGNEE = {2} ", Made4Net.Shared.Util.FormatField(Made4Net.Shared.Util.DateTimeToDbString(_lastrundate.Date)), Made4Net.Shared.Util.FormatField(Made4Net.Shared.Util.DateTimeToDbString(_nextrundate.Date.AddDays(1))), _
