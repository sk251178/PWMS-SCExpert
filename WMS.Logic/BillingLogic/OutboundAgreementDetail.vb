...
<CLSCompliant(False)> Public Class OutboundAgreementDetail
        ...
        For Each dr In dt.Rows
            ...
            Select Case _billbasis
                ...
                Case AgreementDetail.BillingBasis.NumberOfDucments
                    ...
                    dblOrderLineValue = Me.getChargeValue(dt.Rows.Count, "OUTBOUND", dr("orderid"), 1, logger)
            ...
            'Modified for RWMS-597
            dblOrderLineValue = Me.getChargeValue(LineBilling, "OUTBOUND", dr("orderid"), 1, logger)
            logger.writeSeperator("-", 121)
