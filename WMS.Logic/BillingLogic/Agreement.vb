...
#Region "Constructors"
    ...
    Public Sub New(ByVal pConsignee As String, Optional ByVal LoadObj As Boolean = True)
        ...
        Try
            pName = Made4Net.DataAccess.DataInterface.ExecuteScalar(sql)
...
#Region "Accessors"
    ...
    Protected Sub Load()
        ...
        If Not dr.IsNull("MINVALUE") Then _minvalue = dr.Item("MINVALUE")
        If Not dr.IsNull("MAXVALUE") Then _maxvalue = dr.Item("MAXVALUE")
